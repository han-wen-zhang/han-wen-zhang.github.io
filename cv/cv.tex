...
\setlength\itemsep{0em}
	\item{\textbf{H Zhang}. ``Constructing optimal Wannier functions via potential theory: isolated multiband for matrix models." (To be submitted.) }
...
\begin{itemize}
	\setlength\itemsep{0em}
	\item	Organizer -- Applied Mathematics Seminar, Yale University, 2023--present\\
